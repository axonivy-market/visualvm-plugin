...
public class ErrorChartDataSourceNewTest extends AbstractTest {
  ...
  public static Iterable<Object[]> data() throws JAXBException, URISyntaxException {
    return TestUtil.createTestData(
            "/ch/ivyteam/ivy/visualvm/test/datasource/request/ErrorChartDataSourceNewTest.xml",
  ...
  public ErrorChartDataSourceNewTest(BeanTestData.Dataset dataset,
