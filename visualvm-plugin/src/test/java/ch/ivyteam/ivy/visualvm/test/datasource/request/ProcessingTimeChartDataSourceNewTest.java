...
public class ProcessingTimeChartDataSourceNewTest extends AbstractTest {
  ...
  public static Iterable<Object[]> data() throws JAXBException, URISyntaxException {
    return TestUtil.createTestData(
            "/ch/ivyteam/ivy/visualvm/test/datasource/request/ProcessingTimeChartDataSourceNewTest.xml",
  ...
  public ProcessingTimeChartDataSourceNewTest(BeanTestData.Dataset dataset,
