 ...
 /* CHECKSTYLE:ON */
  ...
  public String getSelectedMBean() {
    ...
    if (selectionPath != null) {
      MBeanNode selectedNode = (MBeanNode) selectionPath.getLastPathComponent();
  ...
  void setSelected(String mBean, String attribute) {
    TreePath selectedPath = ((MBeanTreeModel) mBeanTree.getModel()).getTreePathFor(mBean, attribute);
