...
public class ErrorQueryBufferTest extends AbstractTest {
  ...
  private final List<SQLInfo> fExpectedSQLErrors;
  private final int fExpectedNumOfErrors;

  public ErrorQueryBufferTest(BeanTestData.Dataset dataset, int numErrors, List<SQLInfo> sqlErrorInfos) {
    super(dataset);
  ...
  public static Iterable<Object[]> data() throws JAXBException, URISyntaxException, ParseException {
    ...
    SQLInfo sqlErrorInfo1 = new SQLInfo();
    ...
    SQLInfo sqlErrorInfo2 = new SQLInfo();
    ...
    SQLInfo sqlErrorInfo3 = new SQLInfo();
    ...
    List<SQLInfo> sqlErrorInfos1 = new ArrayList<>();
    sqlErrorInfos1.add(sqlErrorInfo1);

    List<SQLInfo> sqlErrorInfos2 = new ArrayList<>();
    sqlErrorInfos2.add(sqlErrorInfo1);
    sqlErrorInfos2.add(sqlErrorInfo2);

    List<SQLInfo> sqlErrorInfos3 = new ArrayList<>();
  ...
  public void testDBErrorQueriesBuffer() throws MalformedObjectNameException, IOException {
    ...
    for (int index = 0; index < fExpectedNumOfErrors; index++) {
      SQLInfo expectedError = fExpectedSQLErrors.get(index);
      SQLInfo actualError = fBuffer.getBuffer().get(index);
