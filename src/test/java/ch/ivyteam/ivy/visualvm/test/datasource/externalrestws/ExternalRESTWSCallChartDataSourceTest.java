...
public class ExternalRESTWSCallChartDataSourceTest extends AbstractTest {

  private static final String DATA_FILE_PATH = "/ch/ivyteam/ivy/visualvm/test/datasource/externalrestws"
          + "/ExternalRESTWSCallChartDataSourceTest.xml";
  ...
  public static Iterable<Object[]> data() throws JAXBException, URISyntaxException {
    return TestUtil.createTestData(
            DATA_FILE_PATH,
            new Object[] {new String[] {"test", "enviroment1", "personService"}, 0, 0, 0, 0},
            new Object[] {new String[] {"test", "enviroment1", "personService"}, 2, 1, 2, 1},
            new Object[] {new String[] {"test", "enviroment1", "personService"}, 1, 0, 2, 1}
            );
  }

  public ExternalRESTWSCallChartDataSourceTest(BeanTestData.Dataset dataset,
